...
export class MovieController {
  public async up_rating(req: any, res: Response) {
    ...
    movie
      ...
      .then((data) => successResponse("hei", data, res));
  }
  ...
  public async down_rating(req: any, res: Response) {
    ...
    movie
      ...
      .then((data) => successResponse("hade", data, res));
  }
  ...
  public get_movie(req: any, res: Response) {
    ...
    if (search != "") {
      if (filter != "") {
        ...
        movie
          .find(
            { genre: filter, title: searchValue },
            (err: any, user_data: IMovie) => {
              if (err) {
                mongoError(err, res);
              } else {
        ...
        movie
          .find({ title: searchValue }, (err: any, user_data: IMovie) => {
            if (err) {
              mongoError(err, res);
            } else {
              successResponse("get user successfull", user_data, res);
